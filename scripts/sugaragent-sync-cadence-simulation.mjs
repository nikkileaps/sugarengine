...
const sourcePath = path.resolve('src/plugins/sugaragent/simulation/cadence.ts');
const outputPath = path.resolve('src/plugins/sugaragent/simulation/cadence.runtime.mjs');
