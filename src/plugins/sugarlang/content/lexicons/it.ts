...
const ITALIAN_EXPLICIT_ENTRIES: LexiconEntry[] = [
  ...
  {
    lexicalEntryId: 'phrase.do_you_know',
    targetForm: 'sai',
    alternates: ['sa', 'sapete'],
    gloss: 'do you know',
    category: 'phrase',
    introductionBand: 'B3',
    usage: 'active',
  ...
  {
    lexicalEntryId: 'phrase.im_going',
    targetForm: 'vado',
    alternates: ['vado a', 'sto andando'],
    gloss: "I'm going",
    category: 'phrase',
    introductionBand: 'B3',
    usage: 'active',
  ...
  {
    lexicalEntryId: 'verb.arrive',
    targetForm: 'arrivato',
    alternates: ['arrivata', 'arrivare'],
    gloss: 'arrived',
    category: 'verb',
    introductionBand: 'B3',
    usage: 'active',
