...
export interface NoveltyState {
  ...
  exhausted: boolean;
  initiativeHistory: Record<string, unknown>;
}

export interface EvidenceFirstTurnPlanResult {
  plan: Record<string, unknown>;
  plannerMeta: {
    selectedEvidence: Array<Record<string, unknown>>;
    rankedEvidence: Array<Record<string, unknown>>;
  };
}
